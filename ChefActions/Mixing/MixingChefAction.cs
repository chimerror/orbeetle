...
public partial class MixingChefAction : ChefAction
{
 ...
 */
        ...
        return candidateIngredient.AllowedStates.Contains(Ingredient.State.Mixed);
    }
    ...
    public override Ingredient ProcessIngredients(IEnumerable<Ingredient> inputIngredients)
    {
        ...
        processedIngredient.CurrentState = Ingredient.State.Mixed;
