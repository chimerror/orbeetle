...
public partial class RoastingChefAction : ChefAction
{
 ...
 */
        ...
        return candidateIngredient.AllowedStates.Contains(Ingredient.State.Roasted);
    }
    ...
    public override Ingredient ProcessIngredients(IEnumerable<Ingredient> inputIngredients)
    {
        ...
        processedIngredient.CurrentState = Ingredient.State.Roasted;
